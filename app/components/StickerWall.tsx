...
export default function StickerWall() {
  ...
  const stickers = [
    ...
    { src: "/stickers/html.png", top: "40%", left: "20%", size: 80, skill: 88 },
    { src: "/stickers/mongodb.png", top: "27%", left: "15%", size: 120, skill: 60 },
    { src: "/stickers/mysql.png", top: "80%", left: "16%", size: 120, skill: 55 },
    { src: "/stickers/figma.png", top: "44%", left: "30%", size: 100, skill: 42 },
    { src: "/stickers/css.png", top: "30%", left: "32%", size: 70, skill: 85 },
    { src: "/stickers/js.png", top: "55%", left: "23%", size: 70, skill: 70 },
    {
